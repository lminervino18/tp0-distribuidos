...
La implementación usa `threading` directamente en lugar de `concurrent.futures.ThreadPoolExecutor`, ya que la cátedra no permite el uso de Futures/Asyncio en este TP0 por abstraer demasiado la coordinación de hilos.
